"""
Alembic environment configuration for the people management system.

This module configures Alembic for database migrations, including
model metadata imports and connection configuration.
"""
...
def run_migrations_online() -> None:
    ...
    """
    # Override the sqlalchemy.url in alembic.ini with our configuration
